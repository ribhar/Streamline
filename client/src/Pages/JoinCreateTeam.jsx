...
const JoinCreateTeam = () => {
  return (
    <div>
      <div>
      <div className=' mt-10 mx-auto rounded flex  w-4/5 h-[500px] p-10 gap-5 bg-orange-200'>
        <div className='w-1/2  h-full text-center bg-white rounded pt-5'>
        ...
        <div className='w-1/2  rounded h-full text-center bg-white pt-5'>
